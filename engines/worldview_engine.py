...
WORLDVIEW_ANALYSIS_PROMPT = (
    ...
    '"role": "角色定位", "personality": "性格特点", "relationship": "与其他角色的关系"}], '
    '"themes": ["主题1", "主题2"], '
    '"special_terms": {"日文术语": "中文译名"}}\n\n'
    "注意：\n"
    "- worldview 必须详细，用于辅助后续翻译理解上下文，控制在500字以内\n"
    "- characters 列出所有主要角色，最多10个\n"
    "- name_cn 是「日文角色名」的中文翻译（人名/称呼），不是角色定位或身份描述。"
    "必须是一个具体的人名或称呼，例如：美咲→美咲、田中先生→田中先生、メイド長→女仆长、"
    "あかり→明里。绝对不要输出「听者」「听众」「主人公」这类角色定位词汇作为 name_cn\n"
